...
void GutyanskyAMonteCarloMultiDimensionMPI::GetScatterParams(int rank, int world_size, int elements_count, int *size,
                                                             int *displacement) {
...
std::vector<int> GutyanskyAMonteCarloMultiDimensionMPI::ScatterA(int rank, int world_size, int rows_a, int cols_a) {
  int local_rows_a = 0;
  int local_start_a = 0;
...
std::vector<int> GutyanskyAMonteCarloMultiDimensionMPI::ScatterB(int rank, int world_size, int rows_b, int cols_b) {
  int local_cols_b = 0;
  int local_start_b = 0;
...
void GutyanskyAMonteCarloMultiDimensionMPI::GatherResult(int rank, int world_size, int rows_a, int cols_b,
